...
and [Plan 30](30-agent-llm-working-ergonomics.md); reuses the field-test prior
art in `test/field-test/skills-install.mts` ([Plan 35](35-blind-agent-field-test.md)).
