...
| **Priority** | P1 |
| **Status** | In progress |
| **Theme** | Everything between "the code is done" and "v0.1.0 is public on GitHub and npm": identity rewrite, repo hygiene, publish pipeline, post-publish verification. |
