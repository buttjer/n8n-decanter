...
**Status:** Done — shipped in PR #162 (code, docs on every surface, agent contract, tests). Renumbered 58 → 60: [plans/done/58-guard-route-robustness.md](58-guard-route-robustness.md) landed first (#164) and owns the number; 59 was already taken by the declutter plan this one spawned.
**Priority:** P1
