...
now recurred across #107/#114/#115 — cleaned up by hand in [Plan 39](OPEN-39-docs-drift-refresh.md)
...
scale — the entire reason [Plan 39](OPEN-39-docs-drift-refresh.md) exists is to
...
- [Plan 0 backlog](BACKLOG.md) "**Cross-PR docs-drift guardrail in CI**"
...
- Directly motivated by [Plan 39](OPEN-39-docs-drift-refresh.md)'s findings: 12
...
5. **Seed it green — sequencing with Plan 39.** Run against current `main` and
   ...
   [Plan 39](OPEN-39-docs-drift-refresh.md) already catalogs (`docs/cli/scenario|simulate|publish.md`,
...
- **Relation to [Plan 39](OPEN-39-docs-drift-refresh.md):** Plan 39 is the
