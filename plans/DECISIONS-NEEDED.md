...
*No open items (2026-07-18). Resolved so far: Docker smoke suite → approved
dev-only, graduated to [Plan 15](OPEN-15-docker-n8n-smoke-suite.md);
bundle compression/minification → dropped (recorded in
[Plan 14](INPROGRESS-14-bundle-shared-code-into-ts-pushes.md) Notes);
