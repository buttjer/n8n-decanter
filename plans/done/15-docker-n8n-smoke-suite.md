...
([Plan 0](../draft/)), the n8n 2.x publish semantics PLAN.md documents from
...
5. **Tags/pinned-data round-trip** (backlog item): tag + pin data on a
   ...
   box in [Plan 0](../draft/) when it holds.
